...
async function criarUrlCurta(req, res) {
 ...
 // Valida se é uma URL válida
  ...
  // Gera um código único de 7 caracteres
    ...
    return res.status(500).json({ erro: "Erro interno ao encurtar a URL." });
  }
}
...
async function redirecionarParaUrlOriginal(req, res) {
  ...
  try {
    ...
    return res.status(500).json({ erro: "Erro interno ao redirecionar." });
  }
}
...
async function listarTodasUrls(req, res) {
  try {
    ...
    return res.status(500).json({ erro: "Erro interno ao listar URLs." });
  }
}
...
async function buscarEstatisticasDaUrl(req, res) {
  ...
  try {
    ...
    return res.status(500).json({ erro: "Erro interno ao buscar URL." });
  }
}
...
async function deletarUrl(req, res) {
  ...
  try {
    ...
    return res.status(500).json({ erro: "Erro interno ao deletar URL." });
  }
}
